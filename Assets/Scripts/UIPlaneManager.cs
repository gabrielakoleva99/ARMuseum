...
{
    public class UIPlaneManager : Singleton<UIPlaneManager>
    {
        private Dictionary<string, UIPlane> panels = new Dictionary<string, UIPlane>();

        private void Awake()
        {
            var temp = Resources.FindObjectsOfTypeAll<UIPlane>();
