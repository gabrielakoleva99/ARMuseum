...
namespace PaintIn3D
{
	...
	[HelpURL(CwCommon.HelpUrlPrefix + "CwVrTool")]
	[AddComponentMenu(CwCommon.ComponentMenuPrefix + "VR Tool")]
	public class CwVrTool : MonoBehaviour
	{
		...
		private static LinkedList<CwVrTool> instances = new LinkedList<CwVrTool>(); private LinkedListNode<CwVrTool> instancesNode;
...
{
	using UnityEditor;
	using TARGET = CwVrTool;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class CwVrTool_Editor : CwEditor
	{
