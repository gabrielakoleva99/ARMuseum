...
namespace PaintIn3D
{
	...
	[HelpURL(CwCommon.HelpUrlPrefix + "CwInputAxis")]
	[AddComponentMenu(CwCommon.ComponentMenuPrefix + "Input Axis")]
...
{
	using UnityEditor;
	using TARGET = CwInputAxis;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class CwInputAxis_Editor : CwEditor
	{
