...
namespace PaintIn3D
{
	...
	[HelpURL(CwCommon.HelpUrlPrefix + "CwVrManager")]
	[AddComponentMenu(CwCommon.ComponentMenuPrefix + "VR Manager")]
	public class CwVrManager : MonoBehaviour
	{
		...
		public static LinkedList<CwVrManager> Instances { get { return instances; } } private static LinkedList<CwVrManager> instances = new LinkedList<CwVrManager>(); private LinkedListNode<CwVrManager> instancesNode;
...
{
	using UnityEditor;
	using TARGET = CwVrManager;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class CwVrManager_Editor : CwEditor
	{
