...
namespace PaintIn3D
{
	/// <summary>This component works like <b>CwHitScreen</b>, but it will fill in the shape you draw.</summary>
	[HelpURL(CwCommon.HelpUrlPrefix + "CwHitScreenFill")]
	[AddComponentMenu(PaintCore.CwCommon.ComponentHitMenuPrefix + "Hit Screen Fill")]
...
{
	using UnityEditor;
	using TARGET = CwHitScreenFill;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class CwHitScreenFill_Editor : CwHitScreen_Editor
	{
