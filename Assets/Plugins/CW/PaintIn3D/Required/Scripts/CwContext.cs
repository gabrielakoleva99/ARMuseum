...
namespace PaintIn3D
{
	public class CwContext
	{
		...
		{
			var gameObject = GetGameObject(menuCommand); return gameObject.GetComponent<CwPaintableMeshAtlas>() == null;
		}
		...
		{
			var gameObject = GetGameObject(menuCommand); AddSingleComponent<CwPaintableMesh>(gameObject);
		}
