...
namespace PaintIn3D
{
	...
	[ExecuteInEditMode]
	[HelpURL(CwCommon.HelpUrlPrefix + "CwHitThrough")]
	[AddComponentMenu(PaintCore.CwCommon.ComponentHitMenuPrefix + "Hit Through")]
	public class CwHitThrough : MonoBehaviour
	{
		...
		public CwLineConnector Connector { get { if (connector == null) connector = new CwLineConnector(); return connector; } } [SerializeField] private CwLineConnector connector;
...
{
	using UnityEditor;
	using TARGET = CwHitThrough;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class CwHitThrough_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			BeginIndent();
				if (Any(tgts, t => t.Orientation == CwHitThrough.OrientationType.CameraUp))
				{
