...
namespace PaintIn3D
{
	...
	[HelpURL(CwCommon.HelpUrlPrefix + "CwHitScreenLine")]
	[AddComponentMenu(PaintCore.CwCommon.ComponentHitMenuPrefix + "Hit Screen Line")]
...
{
	using UnityEditor;
	using TARGET = CwHitScreenLine;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class CwHitScreenLine_Editor : CwHitScreenBase_Editor
	{
		...
		protected override void DrawBasic()
		{
			...
			BeginIndent();
				if (Any(tgts, t => t.Frequency == CwHitScreenLine.FrequencyType.PixelInterval || t.Frequency == CwHitScreenLine.FrequencyType.ScaledPixelInterval || t.Frequency == CwHitScreenLine.FrequencyType.StretchedPixelInterval || t.Frequency == CwHitScreenLine.FrequencyType.StretchedScaledPixelInterval))
				{
				...
				if (Any(tgts, t => t.Frequency == CwHitScreenLine.FrequencyType.Once))
				{
