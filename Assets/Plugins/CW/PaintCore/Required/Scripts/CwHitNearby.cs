...
namespace PaintCore
{
	...
	[HelpURL(CwCommon.HelpUrlPrefix + "CwHitNearby")]
	[AddComponentMenu(CwCommon.ComponentHitMenuPrefix + "Hit Nearby")]
...
{
	using UnityEditor;
	using TARGET = CwHitNearby;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class CwHitNearby_Editor : CwEditor
	{
