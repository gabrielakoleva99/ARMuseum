						...
						if (hitSpacing > 0.0f)
						{
							...
							if (stepsA > 0 || stepsB > 0)
							{
								...
								for (var i = 0; i < steps; i++)
								{
									...
									if (connectHits == true)
									{
										hitCache.InvokeQuad(gameObject, preview, priority, pressure, link.Position, link.EndPosition, currentPositionA, currentPositionB, rotation, clipConnected);
									}
									else
									{
...
namespace PaintCore
{
	...
	public static class CwLineConnector_Editor
	{
