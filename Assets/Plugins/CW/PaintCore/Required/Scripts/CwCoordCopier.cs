...
namespace PaintCore
{
	...
	[ExecuteInEditMode]
	[HelpURL(CwCommon.HelpUrlPrefix + "CwCoordCopier")]
...
{
	using UnityEditor;
	using TARGET = CwCoordCopier;

	[CustomEditor(typeof(TARGET))]
	public class CwCoordCopier_Editor : CwEditor
	{
		[MenuItem("CONTEXT/Mesh/Coord Copier (Paint Core)")]
		public static void Create(MenuCommand menuCommand)
		{
			...
			if (mesh != null)
			{
				...
				var instance = CreateInstance<CwCoordCopier>();
